...
dstPath = '/media/iit/R a i n/2019/Intelligent Machines Ltd/face-propagation/dummy-data-set/colorferet/colorferet/test_blur/edge_enhance/'
...
def image_to_image():
    for item in dirs:
        if os.path.isfile(srcPath + item):
            ...
            img_blur = img.filter(PIL.ImageFilter.EDGE_ENHANCE_MORE)
...
dstPath = "/media/iit/R a i n/2019/Intelligent Machines Ltd/face-propagation/dummy-data-set/colorferet/colorferet/test_blur/edge_enhance/"
mrgPath = "/media/iit/R a i n/2019/Intelligent Machines Ltd/face-propagation/dummy-data-set/colorferet/colorferet/test_blur/original_and_edge_enhance_merge/"
...
def mergeImage():
    ...
    for im in images:
        ...
        if (i % 2 == 0):
            j += 1
            x_offset = 0
            new_im.save(mrgPath + "edge_enhance_" + str(j) + '.jpg')
            #new_im.show()
